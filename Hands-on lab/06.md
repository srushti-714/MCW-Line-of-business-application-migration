...
13. Once the registration is complete, close the **Discover machines** panel using **X** close button.

    ![Screenshot of the Azure Migrate overview blade.](images/updatelob10.png)
